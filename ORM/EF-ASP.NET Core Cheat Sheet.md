...
{
  "ConnectionStrings": {
    "DefaultConnection": "Data Source=.; User Id= Mamad ;Password= 10203040 ;Initial Caltalog= EfCoreDatabase ; Trusted_Connection=true; TrustServerCertificate=true"
  }
}
```
...
<!-- Februery 2023 Muhammad Ganji Nezhad -->
